...
- [ ] `BPI_RigMapper` (EnableRigMapper / OverrideDefinitions) toggle implementation on the character BP; instance-editable Subject variable bound to the pin (PropertyAccess binding) instead of the node-literal default.
